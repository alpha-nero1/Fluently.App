...
import styles from './studyCard.styles';
...
const FeedbackButton = ({ label, onPress, style }: IFeedbackButtonProps) => (
    <TouchableOpacity style={[styles.feedbackButton, style]} onPress={onPress}>
            ...
            backContent={
                <Flex column alignCenter>
                    ...
                    <View style={styles.feedbackSection}>
                        <FeedbackButton label={i18.Fail} onPress={() => _feedbackOnClick(SetCardGrade.D)} style={styles.fail} />
                        <FeedbackButton label={i18.Hard} onPress={() => _feedbackOnClick(SetCardGrade.C)} style={styles.hard} />
                        <FeedbackButton label={i18.Okay} onPress={() => _feedbackOnClick(SetCardGrade.B)} style={styles.okay} />
                        <FeedbackButton label={i18.Easy} onPress={() => _feedbackOnClick(SetCardGrade.A)} style={styles.easy} />
                    </View>
                </Flex>
            }
        />
